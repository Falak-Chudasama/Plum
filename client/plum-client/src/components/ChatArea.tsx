...
import type { CraftedMailType, ResponseType, UserPromptType } from "../types/types";
...
function Response({ responseObj }: { responseObj: ResponseType }) {
    ...
    function SendMailBtn() {
        return (
            <button onClick={() => apis.sendMail(responseObj.craftedMail)} className="bg-plum-secondary flex cursor-pointer items-center justify-center rounded-full px-3 py-1 font-medium">
    ...
    function DraftMailBt() {
        return (
            <button onClick={() => apis.sendMail(responseObj.craftedMail)} className="bg-plum-primary flex cursor-pointer items-center justify-center rounded-full px-3 py-1 font-medium">
