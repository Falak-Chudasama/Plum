    ...
    return (
        <div className={`fixed w-fit h-fit z-50 duration-300 bottom-0 right-0 flex justify-end ${!showMail ? "translate-x-full" : "translate-x-0"}`}>
            <div className="place-items-end pb-10 pr-5">
                <button className="group bg-plum-purple z-50 text-md font-medium font-cabin px-3 pt-0.5 rounded-t-lg mr-5 text-plum-secondary hover:bg-red-600 hover:text-red-50 cursor-pointer flex items-center gap-x-1 duration-350 shadow-plum-secondary-xs select-none" onClick={() => handleCancelBtnClick()}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="11"
                        height="11"
                        viewBox="0 0 11 11"
                        className="fill-plum-secondary group-hover:fill-plum-bg transition-colors duration-300"
                    >
